...
public final class NiceNameHandler
{
  ...
  public static void reloadNames ()
  {
    // Doc types
    {
      ...
      final String sPath = SMPConfigSource.getConfig ().getAsString ("webapp.nicename.doctypes.path");
    ...
    // Processes
    {
      ...
      final String sPath = SMPConfigSource.getConfig ().getAsString ("webapp.nicename.processes.path");
      if (StringHelper.hasText (sPath))
      {
