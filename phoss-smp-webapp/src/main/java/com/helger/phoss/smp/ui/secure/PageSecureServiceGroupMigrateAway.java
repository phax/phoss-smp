 ...
 */
public final class PageSecureServiceGroupMigrateAway extends AbstractSMPWebPage
{
  public PageSecureServiceGroupMigrateAway (@Nonnull @Nonempty final String sID)
  {
