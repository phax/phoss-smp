...
/**
 * This interface must be implemented by all real SMP implementations, so that the REST API can
 * easily be used. It provides information only available in the web application.
 *
...
public interface ISMPServerAPIDataProvider
{
  ...
  /**
   * Get the service group HREF for the passed service group ID. Since this depends on the web
   * address of the server it must be implemented in this interface.
   *
  ...
  /**
   * Get the service metadata HREF for the passed service group and document type ID. Since this
   * depends on the web address of the server it must be implemented in this interface.
   *
   * @param aServiceGroupID
   *        The service group ID. Never <code>null</code>.
   * @param aDocTypeID
