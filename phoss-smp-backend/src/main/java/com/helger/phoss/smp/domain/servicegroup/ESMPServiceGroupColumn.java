 ...
 * @since 8.2.1
 */
public enum ESMPServiceGroupColumn implements ISMPTableColumn <ISMPServiceGroup>
{
  /** The participant identifier - stored as scheme and value in SQL */
  PARTICIPANT_ID ("participantid",
                  new String [] { "sg.businessIdentifierScheme", "sg.businessIdentifier" },
                  new String [] { "id" },
                  true,
                  true,
  ...
  @Nullable
  public static ESMPServiceGroupColumn getFromIDOrNull (@Nullable final String sID)
  {
    return EnumHelper.getFromIDOrNull (ESMPServiceGroupColumn.class, sID);
  }
}
