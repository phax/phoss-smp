...
public final class CSMPServer
{
   ...
   */
  private static final String _ALNUM = "a-z0-9";
  // Hyphen can never be the first or last char of a part
  private static final String _PART = "([" + _ALNUM + "](?:[" + _ALNUM + "\\-]*[" + _ALNUM + "]+)*)";
  public static final String PATTERN_SMP_ID = "^(?i)" + _PART + "(?:\\." + _PART + ")*$";
