...
public enum ESMPRedirectColumn implements ISMPTableColumn <ISMPRedirect>
{
  ...
  private final Comparator <ISMPRedirect> m_aComparator;
  private final Function <ISMPRedirect, String> m_aSearchValueProvider;
  ...
  @Nullable
  public Function <ISMPRedirect, String> getSearchValueProvider ()
  {
    return m_aSearchValueProvider;
  }

  @Nullable
  public Comparator <ISMPRedirect> getComparator ()
  {
