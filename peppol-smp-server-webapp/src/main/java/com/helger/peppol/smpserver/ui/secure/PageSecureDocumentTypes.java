...
@WorkInProgress
public final class PageSecureDocumentTypes extends AbstractSMPWebPageForm <ISMPServiceInformation>
{
  ...
  protected IValidityIndicator isValidToDisplayPage (@Nonnull final WebPageExecutionContext aWPEC)
  {
    ...
    {
      aNodeList.addChild (new BootstrapWarnBox ().addChild ("No service group is present! At least one service group must be present to create a document type for it."));
                                     ...
                                     @Nonnull final ISMPServiceInformation aSelectedObject)
  {
    ...
    aNodeList.addChild (createActionHeader ("Show details of document type"));
  ...
  protected void showListOfExistingObjects (@Nonnull final WebPageExecutionContext aWPEC)
  {
    ...
    for (final ISMPServiceInformation aServiceInfo : aServiceInfoMgr.getAllSMPServiceInformations ())
    {
      ...
      aRow.addCell (Integer.toString (aServiceInfo.getProcessCount ()));
      aRow.addCell ();
    }
