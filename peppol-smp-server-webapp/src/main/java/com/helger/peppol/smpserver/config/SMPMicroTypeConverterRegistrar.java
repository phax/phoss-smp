...
import com.helger.peppol.smpserver.domain.transportprofile.SMPTransportProfileMicroTypeConverter;

@Immutable
@IsSPIImplementation
public final class SMPMicroTypeConverterRegistrar implements IMicroTypeConverterRegistrarSPI
{
