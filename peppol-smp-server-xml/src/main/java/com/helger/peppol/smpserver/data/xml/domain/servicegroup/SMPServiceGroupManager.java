 ...
 */
package com.helger.peppol.smpserver.data.xml.domain.servicegroup;
...
public final class SMPServiceGroupManager extends AbstractWALDAO <SMPServiceGroup>
{
  ...
  {
    final SMPServiceGroup aSMPServiceGroup = new SMPServiceGroup (aOwner, aParticipantIdentifier, sExtension);
                                        ...
                                        @Nullable final String sExtension)
  {
    ...
    try
    {
      ...
      eChange = eChange.or (aSMPServiceGroup.setOwner (aOwner));
    ...
    AuditHelper.onAuditModifySuccess (SMPServiceGroup.OT, "all", sSMPServiceGroupID, aOwner.getID (), sExtension);
