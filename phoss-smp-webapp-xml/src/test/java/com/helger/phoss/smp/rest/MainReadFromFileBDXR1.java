 ...
 */
public final class MainReadFromFileBDXR1
{
  private static final Logger LOGGER = LoggerFactory.getLogger (MainReadFromFileBDXR1.class);
  ...
  {
    final SMPServerRESTTestRule aRule = new SMPServerRESTTestRule (new FileSystemResource ("src/test/resources/test-smp-server-xml-bdxr1.properties"));
    aRule.before ();
    try
    {
...

      {
        ...
        final Response aResponseMsg = ClientBuilder.newClient ()
                                                   ...
                                                   .request ()
                                                   .header (CHttpHeader.AUTHORIZATION, CREDENTIALS.getRequestValue ())
                                                   .put (Entity.xml (new File ("src/test/resources/rest-files/bdxr1-service-group.xml")));
...

      {
        ...
        final Response aResponseMsg = ClientBuilder.newClient ()
                                                   ...
                                                   .request ()
                                                   .header (CHttpHeader.AUTHORIZATION, CREDENTIALS.getRequestValue ())
                                                   .put (Entity.xml (new File ("src/test/resources/rest-files/bdxr1-service-metadata.xml")));
        _testResponseJerseyClient (aResponseMsg, 200);
      }
