...
CREATE TABLE `smp_bce` (
  ...
  `pid` varchar(255) NOT NULL COMMENT 'Participant ID',
  `name` text NOT NULL COMMENT 'Entity name',
  `country` varchar(3) NOT NULL COMMENT 'Countrry code',
  ...
  PRIMARY KEY (`id`),
  KEY `pid-group` (`pid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='SMP Business Card Entitiy';
