 ...
 * To stop the running Jetty simply invoke the {@link JettyStopSMPSERVER_MONGODB} application in
 * this package. It performs a graceful shutdown of the App Server.
 *
