...
public final class SMPRedirectManagerJDBC extends AbstractJDBCEnabledManager implements ISMPRedirectManager
{
                                                 ...
                                                 @Nullable final String sExtension)
  {
    ...
    final ESuccess eSuccess = aExecutor.performInTransaction ( () -> {
      ...
      final IParticipantIdentifier aParticpantID = aServiceGroup.getParticipantIdentifier ();
  ...
  {
    return newExecutor ().queryCount ("SELECT COUNT(*) FROM smp_service_metadata_redirection");
  }
