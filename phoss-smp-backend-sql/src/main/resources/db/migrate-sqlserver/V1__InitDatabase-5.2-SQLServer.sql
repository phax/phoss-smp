...
CREATE TABLE smp_endpoint (
    ...
    requireBusinessLevelSignature bit          NOT NULL,
    serviceActivationDate         datetime2    DEFAULT NULL,
    serviceDescription            varchar(max) NOT NULL,
    serviceExpirationDate         datetime2    DEFAULT NULL,
    technicalContactUrl           VARCHAR(256) NOT NULL,
    technicalInformationUrl       VARCHAR(256) DEFAULT NULL,
-- Reduced from VARCHAR(256) to avoid exceeding 900-byte PK index limit
