...
public final class SMPServiceInformationManagerMongoDB extends AbstractManagerMongoDB implements ISMPServiceInformationManager
{
  ...
  public static SMPEndpoint toEndpoint (@Nonnull final Document aDoc)
  {
    ...
    final OffsetDateTime aServiceActivationDT = TypeConverter.convert (aDoc.getDate (BSON_SERVICEACTIVATION), OffsetDateTime.class);
    final OffsetDateTime aServiceExpirationDT = TypeConverter.convert (aDoc.getDate (BSON_SERVICEEXPIRATION), OffsetDateTime.class);
