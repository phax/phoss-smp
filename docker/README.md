...
```
docker build --build-arg VERSION=5.1.0 -t phoss-smp-release-binary-xml-5.1.0 -f Dockerfile-release-binary-xml .
```
...
```
docker run -d --name phoss-smp-release-binary-xml-5.1.0 -p 8888:8080 phelger/smp:5.1.0
docker stop phoss-smp-release-binary-xml-5.1.0
docker rm phoss-smp-release-binary-xml-5.1.0
```
