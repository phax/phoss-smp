...
```
docker build --build-arg SMP_VERSION=5.3.1 -t phoss-smp-release-binary-xml-5.3.1 -f Dockerfile-release-binary-xml .
```
...
```
docker run -d --name phoss-smp-release-binary-xml-5.3.1 -p 8888:8080 phelger/smp:5.3.1
docker stop phoss-smp-release-binary-xml-5.3.1
docker rm phoss-smp-release-binary-xml-5.3.1
```
