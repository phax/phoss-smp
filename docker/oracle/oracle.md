...
Details 2: https://container-registry.oracle.com/ords/ocr/ba/database/enterprise

Login first (with Oracle username and token):
```
...
docker run -d --name orcl26 -p 1521:1521 -p 5500:5500 -e ORACLE_PWD=password -v OracleDBData:/opt/oracle/oradata container-registry.oracle.com/database/free:latest
```
